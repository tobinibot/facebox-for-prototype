...
var Facebox = Class.create({
	  ...
	  <div id="facebox" style="display:none;"> \
	    <div class="popup"> \
	      <table id="facebox_table"> \
	        <tbody> \
	          <tr> \
	            <td class="tl"/><td id="facebox_top" class="b"/><td class="tr"/> \
	          </tr> \
	          <tr> \
	            <td class="b"/> \
	            <td class="body"> \
  ...
  watchKeyPress : function(e) {
    ...
    if (e.keyCode == 27 || (this.settings.clickOutsideCloses && !Event.element(e).descendantOf(this.facebox))) this.close();
  },
